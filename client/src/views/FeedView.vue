...
export default {
    ...
    computed: {
        ...
        filteredFormDataArray() {
            ...
            return this.formDataArray.filter(entry => entry.userID === session.user?.id);
        },
    },
    methods: {
        openModal() {
...
<template>
    <h1 class="title ml-3">Activity Feed</h1>
    <div class="columns is-centered">
        <div class="column is-one-third">
                    ...
                    <section class="modal-card-body">
                        ...
                        <form @submit="submitForm">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input type="text" id="duration" pattern="^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$"
                                        class="input" v-model="formData.duration">
                                </div>
                            </div>
                            <div class="field">
            ...
            <article class="media mt-5 p-2 is-full-width has-background-white" style="border-radius: 5px;"
                v-for="entry in formDataArray" :key="entry.id">
                ...
                <div class="media-right">
                    <!--add v-if="entry.userID === session.user?.id"-->
